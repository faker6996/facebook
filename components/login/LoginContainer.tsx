    ...
    <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <div className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-600 text-white font-bold text-lg">
            N
          </div>
        ...
        <div className="rounded-lg bg-white dark:bg-neutral-900 px-6 py-8 shadow sm:px-10">
          ...
          <div className="mt-6 flex items-center">
            ...
            <div className="mx-4 text-sm text-gray-500 dark:text-gray-400">Or continue with</div>
            <div className="w-full border-t border-gray-300 dark:border-gray-700" />
          </div>
